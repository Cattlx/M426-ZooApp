...
const TIERE_DATA = [
	...
	},
	{
		...
		bewertungen: 38,
		beschreibung:
			"Der Afrikanische Elefant ist das größte Landtier und zeichnet sich durch bemerkenswerte Intelligenz und starkes Sozialverhalten aus.",
	},
	{
		id: 3,
		name: "Giraffe",
		...
		bewertungen: 35,
		beschreibung:
			"Die Giraffe ist das höchste Landtier und ein elegantes Symbol Afrikas. Ihre lange Halswirbelsäule ermöglicht ihr das Fressen von Baumblättern.",
	},
	{
		id: 4,
		name: "Pinguin",
		...
		bewertungen: 41,
		beschreibung:
			"Der Pinguin ist ein faszinierender flugunfähiger Vogel mit perfekter Anpassung an das Wasserleben. Er lebt in großen Kolonien.",
	},
	{
		id: 5,
		name: "Krokodil",
		...
		bewertungen: 28,
		beschreibung:
			"Das Krokodil ist eines der ältesten und gefährlichsten Reptilien der Welt. Es ist ein perfekter Jäger in Flüssen und Seen.",
	},
	{
		id: 6,
		name: "Adler",
		...
		bewertungen: 33,
		beschreibung:
			"Der Adler ist ein stolzer und majestätischer Raubvogel mit außergewöhnlichem Sehvermögen. Er ist das Wappentier vieler Länder.",
	},
];
...
export default function TierDetail() {
	...
	useEffect(() => {
		document.body.style.background =
			"linear-gradient(180deg, #f0f4f0 0%, #e8f0e8 100%)";
		return () => {
			document.body.style.background =
	...
	if (!tier) {
		return (
			<section className="page tier-detail-page">
				<Link to="/tiere" className="back-link">
					← Zurück
				</Link>
			...
			<div className="detail-ratings">
				...
				<div className="rating-display">
					...
					<span className="rating-text">
						{tier.rating} / 5 ({tier.bewertungen} Bewertungen)
					</span>
				</div>
				<Link to={`/bewertung/${tier.id}`} className="button-review">
					Bewertungen ansehen
				</Link>
			</div>
		</section>
