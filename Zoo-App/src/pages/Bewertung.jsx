...
const TIERE_DATA = [
  { id: 1, name: "Afrikanischer Löwe", emoji: "🦁", kategorie: "Säugetiere", herkunft: "Savanne", rating: 4.8 },
  { id: 2, name: "Elefant", emoji: "🐘", kategorie: "Säugetiere", herkunft: "Afrika", rating: 4.9 },
  { id: 3, name: "Giraffe", emoji: "🦒", kategorie: "Säugetiere", herkunft: "Savanne", rating: 4.7 },
  { id: 4, name: "Pinguin", emoji: "🐧", kategorie: "Vogel", herkunft: "Antarktis", rating: 4.9 },
  { id: 5, name: "Krokodil", emoji: "🐊", kategorie: "Reptil", herkunft: "Wasser", rating: 4.5 },
  { id: 6, name: "Adler", emoji: "🦅", kategorie: "Vogel", herkunft: "Berge", rating: 4.6 },
];

const INITIAL_REVIEWS = [
  { id: 1, tierId: 1, name: "Max M.", sterne: 5, text: "Einfach beeindruckend! Der Löwe hat eine unglaubliche Ausstrahlung.", datum: "12.03.2026" },
  { id: 2, tierId: 1, name: "Anna K.", sterne: 4, text: "Sehr schönes Gehege, der Löwe war aber gerade am Schlafen.", datum: "08.03.2026" },
  { id: 3, tierId: 2, name: "Tom B.", sterne: 5, text: "Die Elefanten sind faszinierend. Man könnte stundenlang zusehen!", datum: "15.03.2026" },
  { id: 4, tierId: 2, name: "Sarah L.", sterne: 5, text: "Mein absolutes Lieblingstier im ganzen Zoo!", datum: "10.03.2026" },
  { id: 5, tierId: 3, name: "Julia W.", sterne: 4, text: "Die Giraffen sind so elegant. Toll beobachtbar von der Plattform.", datum: "05.03.2026" },
  { id: 6, tierId: 4, name: "Peter R.", sterne: 5, text: "Die Pinguin-Fütterung war das Highlight unseres Besuchs!", datum: "14.03.2026" },
  { id: 7, tierId: 4, name: "Lisa M.", sterne: 5, text: "So niedlich wie sie watscheln! Absolute Empfehlung.", datum: "01.03.2026" },
  { id: 8, tierId: 5, name: "Kevin S.", sterne: 4, text: "Beeindruckende Größe, aber etwas versteckt im Gehege.", datum: "11.03.2026" },
  { id: 9, tierId: 6, name: "Nina F.", sterne: 5, text: "Die Flugvorführung war unglaublich!", datum: "09.03.2026" },
];
